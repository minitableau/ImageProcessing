...
plt.imshow(image)
plt.show()
# permet de crée une fenêtre toute noir
...
print("La fenêtre possède", a - 1, "lignes et", b - 1, "colones")
...
imagepil = Image.fromarray(im)  # Transformation du tableau en fenêtre PIL
imagepil.save("../../test/Imagemodif.jpg")  # sauvegarde de la fenêtre modifié
